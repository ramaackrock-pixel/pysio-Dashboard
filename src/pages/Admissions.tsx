              ...
              <tr key={p.id} className="hover:bg-slate-50 transition-colors group">
                ...
                <td className="px-6 py-5">
                   <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold border uppercase tracking-wide ${
                     p.status === 'ADMITTED' ? 'bg-teal-50 text-teal-600 border-teal-100' : 'bg-slate-50 text-slate-500 border-slate-200'
                   }`}>
                     {p.status}
                   </span>
                </td>
         ...
         <div key={room.id} className={`bg-white p-6 rounded-3xl border ${room.status === 'AVAILABLE' ? 'border-teal-100 shadow-teal-500/5' : 'border-slate-100 shadow-sm'} group hover:shadow-xl transition-all`}>
            <div className="flex justify-between items-start mb-6">
               ...
               <div className={`text-[9px] font-black uppercase tracking-widest px-2 py-1 rounded-full border ${
                 room.status === 'AVAILABLE' ? 'bg-teal-50 text-teal-600 border-teal-100' : 'bg-slate-50 text-slate-400 border-slate-200'
               }`}>
                  {room.status}
               </div>
            </div>
